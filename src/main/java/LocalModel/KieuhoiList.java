...
public class KieuhoiList {
    private String idChiNhanh;
    private String soPhieu;
    private Number stt;
    private Date ngaycapnhat;
    private Number solanin;
    ...
    private Number solaninGiaophieu;
    ...
    private String treophieu;
    private Number phihoahong;
    private String giotinhNam;
    private String namsinh;
    private Number solanXuatfile;
    ...
    private Number idSms;
    private Number idGiaodich;
    private String idBank;
    private Number dotck;
    ...
    private Number sttImpDt;
    private String idDieuchinhct;
    private Number tygiaDc;
    ...
    private Number thoigiaxuly;
    private String trangthaixuly;
    private String idlydohuytt;
    ...
    public Number getThoigiaxuly() {
        return thoigiaxuly;
    }

    public void setThoigiaxuly(Number thoigiaxuly) {
    ...
    public String getIdlydohuytt() {
        return idlydohuytt;
    }

    public void setIdlydohuytt(String idlydohuytt) {
        this.idlydohuytt = idlydohuytt;
    }
    ...
    public Number getSolanin() {
        return solanin;
    }

    public void setSolanin(Number solanin) {
    ...
    public Number getSolandichitra() {
        return solandichitra;
    }

    public void setSolandichitra(Number solandichitra) {
    ...
    public Number getSolaninGiaophieu() {
        return solaninGiaophieu;
    }

    public void setSolaninGiaophieu(Number solaninGiaophieu) {
    ...
    public String getTreophieu() {
        return treophieu;
    }

    public void setTreophieu(String treophieu) {
        this.treophieu = treophieu;
    }

    public Number getPhihoahong() {
        return phihoahong;
    }

    public void setPhihoahong(Number phihoahong) {
        this.phihoahong = phihoahong;
    }

    public String getGiotinhNam() {
        return giotinhNam;
    }

    public void setGiotinhNam(String giotinhNam) {
    ...
    public Number getSolanXuatfile() {
        return solanXuatfile;
    }

    public void setSolanXuatfile(Number solanXuatfile) {
    ...
    public Number getHbfileno() {
        return hbfileno;
    }

    public void setHbfileno(Number hbfileno) {
    ...
    public Number getIdSms() {
        return idSms;
    }

    public void setIdSms(Number idSms) {
        this.idSms = idSms;
    }

    public Number getIdGiaodich() {
        return idGiaodich;
    }

    public void setIdGiaodich(Number idGiaodich) {
    ...
    public Number getDotck() {
        return dotck;
    }

    public void setDotck(Number dotck) {
        this.dotck = dotck;
    }
    ...
    public Number getSolaninDiduong() {
        return solaninDiduong;
    }

    public void setSolaninDiduong(Number solaninDiduong) {
    ...
    public Number getSlinNoname() {
        return slinNoname;
    }

    public void setSlinNoname(Number slinNoname) {
        this.slinNoname = slinNoname;
    }
    ...
    public Number getSotiengoc() {
        return sotiengoc;
    }

    public void setSotiengoc(Number sotiengoc) {
    ...
    public Number getSttImpDt() {
        return sttImpDt;
    }

    public void setSttImpDt(Number sttImpDt) {
    ...
    public Number getTygiaDc() {
        return tygiaDc;
    }

    public void setTygiaDc(Number tygiaDc) {
    ...
    public String getIdHoibaoMobile() {
        return idHoibaoMobile;
    }

    public void setIdHoibaoMobile(String idHoibaoMobile) {
        this.idHoibaoMobile = idHoibaoMobile;
    }
    ...
    public String getXacnhandoitac() {
        return xacnhandoitac;
    }

    public void setXacnhandoitac(String xacnhandoitac) {
        this.xacnhandoitac = xacnhandoitac;
    }
