...
public class VwTkttBiennhanMaster {
    ...
    private String so_ct_tuythan;
    private Date ngaycap;
    private Date ngay_chitra_true;
    private String id_nv_chitra;
    private String id_diadiemchitra;
    ...
    private String noidungcmtoday ;
    private String ngaychuyencmtoday;

    public String getNgaychuyencmtoday() {
        return ngaychuyencmtoday;
    }

    public void setNgaychuyencmtoday(String ngaychuyencmtoday) {
        this.ngaychuyencmtoday = ngaychuyencmtoday;
    }
    ...
    public Integer getSobn() {
        return sobn;
    }

    public void setSobn(Integer sobn) {
        this.sobn = sobn;
    }
    ...
    public String getSo_ct_tuythan() {
        return so_ct_tuythan;
    }

    public void setSo_ct_tuythan(String so_ct_tuythan) {
        this.so_ct_tuythan = so_ct_tuythan;
    }
    ...
    public Date getNgay_chitra_true() {
        return ngay_chitra_true;
    }

    public void setNgay_chitra_true(Date ngay_chitra_true) {
        this.ngay_chitra_true = ngay_chitra_true;
    }

    
    

    public void setId_nv_chitra(String id_nv_chitra) {
        this.id_nv_chitra = id_nv_chitra;
    }

    public String getId_diadiemchitra() {
        return id_diadiemchitra;
    }

    public void setId_diadiemchitra(String id_diadiemchitra) {
        this.id_diadiemchitra = id_diadiemchitra;
    }
    ...
    public Integer getSolandichitra() {
        return solandichitra;
    }

    public void setSolandichitra(Integer solandichitra) {
    ...
    public String getId_nv_chitra() {
        return id_nv_chitra;
    }

    public String getNoidungcmtoday() {
        return noidungcmtoday;
    }

    public void setNoidungcmtoday(String noidungcmtoday) {
        this.noidungcmtoday = noidungcmtoday;
    }
