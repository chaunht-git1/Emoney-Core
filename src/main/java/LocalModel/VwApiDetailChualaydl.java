...
/* 
Mục đích: Chứa dữ liệu api detai chưa duyệt
Lưu ý: 
Nhân viên: THACHHH 
Ngày tạo: 07-02-2017
Chỉnh sửa gần nhất: 
...
public class VwApiDetailChualaydl {
    ...
    private Number sttcol;
    private String apikey;
    private String maqlds;
    private String laydulieu;
    ...
    public Number getSttcol() {
        return sttcol;
    }

    public void setSttcol(Number sttcol) {
        this.sttcol = sttcol;
    }
    ...
    public String getLaydulieu() {
        return laydulieu;
    }

    public void setLaydulieu(String laydulieu) {
        this.laydulieu = laydulieu;
    }
}
